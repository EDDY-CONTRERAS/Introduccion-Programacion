...
int I = 0;
float SAL, PRO, NOM = 0;
printf ("Ingrese le salario del profesor:\t");
/* Observa que al menos se necesita ingresar al salario de un profesor para que no ocurra un error de ejecucion del programa. */
scanf ("&f", &SAL);
do
{
    NOM = NOM + SAL;
