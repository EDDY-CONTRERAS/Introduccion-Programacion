...
void main(void)
{
    ...
    Lectura(VE1, MAX); /* Se llama a la funcion Lectura. Observa que el paso del arreglo a la funcion
...
void Imprime(int VEC[], int T) /* La funcion Imprime se utiliza para imprimir un arreglo unidimensional de T elementos de tipo entero. */
int I;
{
    for(I = 0; I < T; I++)
        printf("\nVEC[%d]: %d", I + 1, VEC[I]);
