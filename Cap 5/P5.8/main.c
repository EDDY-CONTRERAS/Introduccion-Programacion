...
void main(void)
 ...
 void Primo(int A, int *B) /* Esta funcion determina si A es primo, en cuyo caso el valor de *B no se altera. */
 {
     int DI = 3;
     while(*B && (DI < (A / 2)))
     {
 ...
 void imprime(int Primos[], int T) /* Esta funcion imprime el arreglo unidimensional de numeros primos. */
 {
     int I;
     for (I = 0; I < T; I++)
