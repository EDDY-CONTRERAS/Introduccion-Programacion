...
int RA4 = 0;
int RA5 = 0;
/* El uso de variables globales no es muy recomendable. En estos problemas se utilizan unicamente con el objetivo de que el lector pueda observar la
...
void main(void)
{
    ...
    while (CAL != -1)
    {
        Rango(CAL); /* Llamada a la funcion Rango. Se pasa un parametro por
        valor. */
