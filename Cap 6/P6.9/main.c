...
/* Asigna.
El programa, al recibir un arreglo bidimensional cuadrado, asigna elementos en funcion del modulo (residuo) a un
...
/* Esta funcion se utiliza tanto para calcular el modulo entre el indice del arreglo unidimensional y 3, como
 para llamar a las funciones correspondientes para resolver el problema. */
{
int I;
for (I=0; I<N; I++)
switch (I%3)
