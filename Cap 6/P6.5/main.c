...
/* Alumnos.
El programa, al recibir un arreglo bidimensional que contiene informacion sobre calificaciones de alumnos en cuatro materias diferentes, obtiene
...
} /* Se verifica que el numero de alumnos del grupo sea válido. */
...
/* Esta funcion se utiliza tanto para obtener el promedio de cada examen, así
como tambien el examen que obtuvo el promedio más alto. */
{
int I, J, MAY;
