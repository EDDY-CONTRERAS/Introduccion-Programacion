...
/* Casa de bolsa.
El programa, al recibir como datos los precios mensuales de las acciones de sus cinco fondos de inversion,
ademas del precio de las acciones al 31 de diciembre del 2003, genera informacion estadistica importante para la empresa. */
...
/* REN es un arreglo unidimensional de tipo real que se utilizara para almacenar el rendimiento anual de los fondos de inversion. */
LecturaM(FON, 5, 12);
LecturaV(PRE, 5);
F1(FON, 5, 12, PRE, REN);
F2(FON, 5, 12);
...
{
/* La funcion F1 se utiliza para calcular el rendimiento anual de los fondos de inversion.
 El resultado se almacena en el arreglo unidimensional V. */
int I;
...
{
/* Esta funcion calcula el promedio anualizado de las acciones de los diferentes fondos. */
int I, J;
float SUM, PRO;
