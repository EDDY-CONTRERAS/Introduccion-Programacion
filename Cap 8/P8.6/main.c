...
{
    producto INV[100];
    /* Se declara un arreglo unidimensional de tipo estructura producto. */ int TAM, OPE;
    do
    {
...
{
for (J = *T; J > I; J--)
    /* Se inserta el nuevo producto en el arreglo. Se mueven una posición a la derecha los elementos
