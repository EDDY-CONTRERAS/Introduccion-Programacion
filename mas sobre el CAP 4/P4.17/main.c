...
/* Lluvias.
El programa permite calcular el promedio mensual de las lluvias caidas en tres regiones importantes del pais. Determina tambien
cual es la region con mayor promedio de lluvia anual. */
